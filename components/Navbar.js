...
export default function Navbar() {
  ...
  // Obtener el usuario y la función para establecer el usuario desde el contexto de autenticación
  ...
  return (
    <div>
      ...
      <nav className="absolute inset-x-0 top-0 z-40 px-4 py-4 flex justify-between items-center bg-transparent" style={{ backgroundColor: 'transparent', boxShadow: 'none' }}>
        ...
        {/* Botones de acceso y registro o botón de salir según el estado del usuario */}
